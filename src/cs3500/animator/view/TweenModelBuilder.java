...
public interface TweenModelBuilder<T> {
  ...
  /**
   * Add a new oval to the model with the given specifications, layer one.
   *
   ...
   * @param layer the layer of shape
  ...
  /**
   * Add a new rectangle to the model with the given specifications, layer one.
   *
   * @param name        the unique name given to this shape
